...
Read the report: `files.written` names what a normal run would
...
- [Report what a run did](report-what-a-run-did.md).
- [Options reference](../reference-options.md#control).

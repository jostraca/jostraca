...
exports.TREE_CMP = exports.cmpTree = exports.DiffUtil = exports.PointUtil = exports.List = exports.Copy = exports.ListItems = exports.CopyFiles = exports.Slot = exports.Line = exports.Folder = exports.Fragment = exports.Inject = exports.File = exports.Content = exports.Project = exports.omap = exports.deep = exports.ucf = exports.lcf = exports.partify = exports.isbinext = exports.isbincontent = exports.indent = exports.escre = exports.template = exports.names = exports.vmap = exports.cmap = exports.kebabify = exports.snakify = exports.camelify = exports.getx = exports.get = exports.each = exports.BuildContext = void 0;
...
Object.defineProperty(exports, "Copy", { enumerable: true, get: function () { return CopyFiles_1.Copy; } });
...
Object.defineProperty(exports, "ListItems", { enumerable: true, get: function () { return ListItems_1.ListItems; } });
Object.defineProperty(exports, "List", { enumerable: true, get: function () { return ListItems_1.List; } });
...
const OptionsShape = (0, shape_1.Shape)({
    ...
    now: (0, shape_1.Skip)((0, shape_1.Nullable)(Function)), // Provide current time.
    log: (0, shape_1.Skip)((0, shape_1.Fault)(LOG_FAULT, (0, shape_1.Check)(isLogger))), // Logging interface.
    ...
    exclude: (0, shape_1.Skip)(Boolean), // Exclude modified output files. Default: `false`.
    // Validated in separate shape to allow overriding.
    existing: { txt: {}, bin: {} },
    model: (0, shape_1.Skip)({}),
    build: (0, shape_1.Skip)(Boolean), // Run the build phase. Default: `true`.
    ...
    // "[object Object]".
    vol: (0, shape_1.Skip)((0, shape_1.Child)((0, shape_1.One)((0, shape_1.Empty)(String), Buffer, null), {})),
    ...
    cmp: {
        Copy: {
            ignore: [(0, shape_1.One)(String, RegExp)]
        }
    },
...
function Jostraca(gopts_in) {
    ...
    async function generate(opts_in, root) {
        ...
        const doBuild = false !== (opts.build ?? gOpts.build ?? true);
    ...
    async function check(opts, root) {
        return (0, check_1.checkRun)(generate, opts, root, gOpts);
    }
    return {
        generate,
        check,
